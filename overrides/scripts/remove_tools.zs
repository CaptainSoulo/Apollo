print("Removing Vanilla Items for Mods");
...
recipes.remove(<cyclicmagic:sandstone_hoe>);
...
//
// Chain
<minecraft:chainmail_helmet>.maxDamage = 1;
<minecraft:chainmail_chestplate>.maxDamage = 1;
<minecraft:chainmail_leggings>.maxDamage = 1;
<minecraft:chainmail_boots>.maxDamage = 1;
...
// Crafting Tools adjusted to 1 durability
//
// Pickaxes
